...
#
# Generated by export_simulation on Tue Sep 24 12:52:11 CEST 2024
#
################################################################################
...
'-reset_run' switch to the './pwm.sh' script.
...
./pwm.sh -noclean_files

For more information on the script, please type './pwm.sh -help'.
