...
# Hierarchical cell: PS_Unit
proc create_hier_cell_PS_Unit { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_PS_Unit() - Empty argument(s)!"}
     return
  }
...
proc create_root_design { parentCell } {
  ...
  # Create instance: PS_Unit
  create_hier_cell_PS_Unit [current_bd_instance .] PS_Unit

  # Create interface connections
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins PS_Unit/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins PS_Unit/FIXED_IO]
