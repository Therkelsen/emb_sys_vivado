...
HD_PWD='/home/therk/emb_sys_vivado/project_2/project_2.runs/UART_to_PWM_counter_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UART_to_PWM_counter_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UART_to_PWM_counter_0_0.tcl
