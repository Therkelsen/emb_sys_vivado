...
################################################################
# This is a generated script based on design: UART_to_PWM
#
...
proc create_hier_cell_UART { parentCell nameHier } {
  ...
  connect_bd_net -net Net [get_bd_pins rst] [get_bd_pins clk_divider_0/rst] [get_bd_pins rx_mod_0/rst]
  connect_bd_net -net Net1 [get_bd_pins clk] [get_bd_pins clk_divider_0/clk]
...
proc create_hier_cell_PWM { parentCell nameHier } {
  ...
  connect_bd_net -net Net [get_bd_pins rst] [get_bd_pins counter_0/rst]
  connect_bd_net -net Net1 [get_bd_pins clk] [get_bd_pins counter_0/clk]
  connect_bd_net -net comparator_0_c [get_bd_pins LED] [get_bd_pins comparator_0/c]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net Net [get_bd_ports rst] [get_bd_pins PWM/rst] [get_bd_pins UART/rst]
  connect_bd_net -net Net1 [get_bd_ports clk] [get_bd_pins PWM/clk] [get_bd_pins UART/clk]
  connect_bd_net -net comparator_0_c [get_bd_ports LED] [get_bd_pins PWM/LED]
