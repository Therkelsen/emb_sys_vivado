...
proc create_hier_cell_PS { parentCell nameHier } {
  ...
  # Create instance: blk_mem_gen_0_0, and set properties
  set blk_mem_gen_0_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.4 blk_mem_gen_0_0 ]
  set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net axi_bram_ctrl_0_BRAM_PORTA [get_bd_intf_pins axi_bram_ctrl_0/BRAM_PORTA] [get_bd_intf_pins blk_mem_gen_0_0/BRAM_PORTA]
  ...
  # Create port connections
  connect_bd_net -net addrb_1 [get_bd_pins addrb] [get_bd_pins blk_mem_gen_0_0/addrb]
  connect_bd_net -net clkb_1 [get_bd_pins clkb] [get_bd_pins blk_mem_gen_0_0/clkb]
  connect_bd_net -net dinb_1 [get_bd_pins dinb] [get_bd_pins blk_mem_gen_0_0/dinb]
  connect_bd_net -net en_0_1 [get_bd_pins enb] [get_bd_pins blk_mem_gen_0_0/enb]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins smartconnect_1/aresetn]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins smartconnect_1/aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N]
  connect_bd_net -net rstb_1 [get_bd_pins rstb] [get_bd_pins blk_mem_gen_0_0/rstb]
  connect_bd_net -net web_1 [get_bd_pins web] [get_bd_pins blk_mem_gen_0_0/web]
