...
ISEStep( "vivado",
         "-log UART_BRAM_Interfacing_axi_bram_ctrl_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UART_BRAM_Interfacing_axi_bram_ctrl_0_0.tcl" );
