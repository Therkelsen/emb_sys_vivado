...
HD_PWD='/home/therk/emb_sys_vivado/bram_assignment/bram_assignment.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UART_BRAM_Interfacing_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UART_BRAM_Interfacing_wrapper.tcl
