...
################################################################
# This is a generated script based on design: UART_BRAM_Interfacing
#
...
# source UART_BRAM_Interfacing_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# padder, clk_divider, rx_mod
...
set design_name UART_BRAM_Interfacing
...
proc create_hier_cell_UART { parentCell nameHier } {
  ...
  connect_bd_net -net rst_1 [get_bd_pins rst_0] [get_bd_pins clk_divider_0/rst] [get_bd_pins rx_mod_0/rst]
...
proc create_hier_cell_PS { parentCell nameHier } {
  ...
  connect_bd_net -net clk_1 [get_bd_pins clk] [get_bd_pins blk_mem_gen_0/clkb]
  connect_bd_net -net dinb_1 [get_bd_pins dinb] [get_bd_pins blk_mem_gen_0/dinb]
  connect_bd_net -net en_1 [get_bd_pins en] [get_bd_pins blk_mem_gen_0/enb]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  ...
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins smartconnect_0/aresetn]
  connect_bd_net -net rst_1 [get_bd_pins rst] [get_bd_pins blk_mem_gen_0/rstb]
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLK_DOMAIN {UART_inst_12PWM_clk_0} \
 ] $clk_0
  ...
  # Create instance: addr_0, and set properties
  set addr_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 addr_0 ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {1073741828} \
   CONFIG.CONST_WIDTH {32} \
 ] $addr_0

  # Create instance: en_0, and set properties
  set en_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 en_0 ]

  # Create instance: padder_0, and set properties
  set block_name padder
  set block_cell_name padder_0
  if { [catch {set padder_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $padder_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  # Create instance: web_0, and set properties
  set web_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 web_0 ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {15} \
  ...
  connect_bd_net -net addrb_1 [get_bd_pins PS/addrb] [get_bd_pins addr_0/dout]
  connect_bd_net -net clk_1 [get_bd_ports clk_0] [get_bd_pins PS/clk] [get_bd_pins UART/clk_0]
  connect_bd_net -net en_0_dout [get_bd_pins PS/en] [get_bd_pins en_0/dout]
  connect_bd_net -net padder_0_dout [get_bd_pins PS/dinb] [get_bd_pins padder_0/dout]
  connect_bd_net -net rst_1 [get_bd_ports rst_0] [get_bd_pins PS/rst] [get_bd_pins UART/rst_0]
  connect_bd_net -net sin_1 [get_bd_ports sin_0] [get_bd_pins UART/sin_0]
  connect_bd_net -net web_1 [get_bd_pins PS/web] [get_bd_pins web_0/dout]
