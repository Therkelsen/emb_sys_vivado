...
################################################################
# This is a generated script based on design: UART2PWM
#
...
# source UART2PWM_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# BRAM_Interface, clk_divider, rx_mod
...
if { $run_remote_bd_flow == 1 } {
  ...
  set origin_dir ./emb_sys_vivado/blocks
...
proc create_hier_cell_UART { parentCell nameHier } {
  ...
  connect_bd_net -net rx_mod_0_intr [get_bd_pins intr] [get_bd_pins rx_mod_0/intr]
  connect_bd_net -net sin_1 [get_bd_pins sin_0] [get_bd_pins rx_mod_0/sin]
...
proc create_hier_cell_BRAM { parentCell nameHier } {
  ...
  create_bd_pin -dir O rsta_busy_0
  create_bd_pin -dir O rstb_busy_0
  ...
  connect_bd_net -net blk_mem_gen_0_rsta_busy [get_bd_pins rsta_busy_0] [get_bd_pins blk_mem_gen_0/rsta_busy]
  connect_bd_net -net blk_mem_gen_0_rstb_busy [get_bd_pins rstb_busy_0] [get_bd_pins blk_mem_gen_0/rstb_busy]
  connect_bd_net -net clk_1 [get_bd_pins clk] [get_bd_pins blk_mem_gen_0/clka] [get_bd_pins blk_mem_gen_0/clkb]
  connect_bd_net -net dinb_1 [get_bd_pins dinb] [get_bd_pins blk_mem_gen_0/dinb]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins smartconnect_0/aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins blk_mem_gen_0/rstb] [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N]
  connect_bd_net -net web_1 [get_bd_pins web] [get_bd_pins blk_mem_gen_0/web]
...
proc create_root_design { parentCell } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net BRAM_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins BRAM/DDR]
  connect_bd_intf_net -intf_net BRAM_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins BRAM/FIXED_IO]

  # Create port connections
  connect_bd_net -net BRAM_Interface_0_BRAM_addr [get_bd_pins BRAM/addrb] [get_bd_pins BRAM_Interface_0/BRAM_addr]
  connect_bd_net -net BRAM_Interface_0_BRAM_din [get_bd_pins BRAM/dinb] [get_bd_pins BRAM_Interface_0/BRAM_din]
  connect_bd_net -net BRAM_Interface_0_BRAM_we [get_bd_pins BRAM/web] [get_bd_pins BRAM_Interface_0/BRAM_we]
  connect_bd_net -net BRAM_rsta_busy_0 [get_bd_ports rsta_busy_0] [get_bd_pins BRAM/rsta_busy_0]
  connect_bd_net -net BRAM_rstb_busy_0 [get_bd_ports rstb_busy_0] [get_bd_pins BRAM/rstb_busy_0]
  connect_bd_net -net UART_data_out [get_bd_pins BRAM_Interface_0/din] [get_bd_pins UART/data_out]
  connect_bd_net -net UART_intr [get_bd_pins BRAM_Interface_0/intr] [get_bd_pins UART/intr]
  connect_bd_net -net clk_0_1 [get_bd_ports clk_0] [get_bd_pins BRAM/clk] [get_bd_pins BRAM_Interface_0/clk] [get_bd_pins UART/clk_0]
  connect_bd_net -net rst_0_1 [get_bd_ports rst_0] [get_bd_pins BRAM_Interface_0/rst] [get_bd_pins UART/rst_0]
  connect_bd_net -net sin_1 [get_bd_ports sin_0] [get_bd_pins UART/sin_0]

  # Create address segments
  assign_bd_address -offset 0x40000000 -range 0x00002000 -target_address_space [get_bd_addr_spaces BRAM/processing_system7_0/Data] [get_bd_addr_segs BRAM/axi_bram_ctrl_0/S_AXI/Mem0] -force
