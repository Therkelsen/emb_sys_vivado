...
# module references:
# LUT, comparator, counter, clk_divider, rx_mod, xl_slice
...
proc create_hier_cell_UART { parentCell nameHier } {
  ...
  # Create instance: xl_slice_0, and set properties
  set block_name xl_slice
  set block_cell_name xl_slice_0
  if { [catch {set xl_slice_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $xl_slice_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_net -net rx_mod_0_data_out [get_bd_pins rx_mod_0/data_out] [get_bd_pins xl_slice_0/Din]
  connect_bd_net -net sin_1 [get_bd_pins sin] [get_bd_pins rx_mod_0/sin]
  connect_bd_net -net xl_slice_0_Dout [get_bd_pins Dout] [get_bd_pins xl_slice_0/Dout]
...
proc create_hier_cell_PWM { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_PWM() - Empty argument(s)!"}
     return
  }
  ...
  create_bd_pin -dir I -from 26 -to 0 b
  create_bd_pin -dir I -type clk clk_0
...
proc create_root_design { parentCell } {
  ...
  # Create port connections
  connect_bd_net -net LUT_0_bits [get_bd_pins LUT_0/bits] [get_bd_pins PWM/b]
  connect_bd_net -net clk_0_1 [get_bd_ports clk_0] [get_bd_pins PWM/clk_0] [get_bd_pins UART/clk_0]
  connect_bd_net -net comparator_0_c [get_bd_ports LED_0] [get_bd_pins PWM/LED_0]
  connect_bd_net -net en_0_1 [get_bd_ports en_0] [get_bd_pins PWM/en_0]
  connect_bd_net -net rst_0_1 [get_bd_ports rst_0] [get_bd_pins PWM/rst_0] [get_bd_pins UART/rst_0]
  connect_bd_net -net sin_1 [get_bd_ports sin_0] [get_bd_pins UART/sin]
  connect_bd_net -net xl_slice_0_Dout [get_bd_pins LUT_0/percent] [get_bd_pins UART/Dout]
