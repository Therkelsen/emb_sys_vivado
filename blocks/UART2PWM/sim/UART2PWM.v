...
module BRAM_imp_ZUK9FE
  ...
  assign clk_1 = clk;
  assign dinb_1 = dinb[31:0];
  assign rsta_busy_0 = blk_mem_gen_0_rsta_busy;
  assign rstb_busy_0 = blk_mem_gen_0_rstb_busy;
  assign web_1 = web[3:0];
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x40000000 32 > UART2PWM BRAM/blk_mem_gen_0" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  UART2PWM_axi_bram_ctrl_0_1 axi_bram_ctrl_0
  ...
  UART2PWM_blk_mem_gen_0_0 blk_mem_gen_0
       (.addra({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,axi_bram_ctrl_0_BRAM_PORTA_ADDR}),
        ...
        .web(web_1));
  UART2PWM_proc_sys_reset_0_0 proc_sys_reset_0
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
  ...
  (* BMM_INFO_PROCESSOR = "arm > UART2PWM BRAM/axi_bram_ctrl_0" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  UART2PWM_processing_system7_0_1 processing_system7_0
  ...
  UART2PWM_smartconnect_0_0 smartconnect_0
...
(* CORE_GENERATION_INFO = "UART2PWM,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=UART2PWM,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=10,numReposBlks=8,numNonXlnxBlks=0,numHierBlks=2,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=3,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=1,da_bram_cntlr_cnt=1,da_clkrst_cnt=5,da_ps7_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "UART2PWM.hwdef" *) 
module UART2PWM
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  wire [14:0]BRAM_DDR_ADDR;
  wire [2:0]BRAM_DDR_BA;
  wire BRAM_DDR_CAS_N;
  wire BRAM_DDR_CKE;
  wire BRAM_DDR_CK_N;
  wire BRAM_DDR_CK_P;
  wire BRAM_DDR_CS_N;
  wire [3:0]BRAM_DDR_DM;
  wire [31:0]BRAM_DDR_DQ;
  wire [3:0]BRAM_DDR_DQS_N;
  wire [3:0]BRAM_DDR_DQS_P;
  wire BRAM_DDR_ODT;
  wire BRAM_DDR_RAS_N;
  wire BRAM_DDR_RESET_N;
  wire BRAM_DDR_WE_N;
  wire BRAM_FIXED_IO_DDR_VRN;
  wire BRAM_FIXED_IO_DDR_VRP;
  wire [53:0]BRAM_FIXED_IO_MIO;
  wire BRAM_FIXED_IO_PS_CLK;
  wire BRAM_FIXED_IO_PS_PORB;
  wire BRAM_FIXED_IO_PS_SRSTB;
  wire [31:0]BRAM_Interface_0_BRAM_addr;
  wire [31:0]BRAM_Interface_0_BRAM_din;
  wire [3:0]BRAM_Interface_0_BRAM_we;
  wire BRAM_rsta_busy_0;
  wire BRAM_rstb_busy_0;
  ...
  assign rsta_busy_0 = BRAM_rsta_busy_0;
  assign rstb_busy_0 = BRAM_rstb_busy_0;
  assign sin_1 = sin_0;
  BRAM_imp_ZUK9FE BRAM
       (.DDR_addr(DDR_addr[14:0]),
        .DDR_ba(DDR_ba[2:0]),
        .DDR_cas_n(DDR_cas_n),
        .DDR_ck_n(DDR_ck_n),
        ...
        .addrb(BRAM_Interface_0_BRAM_addr),
        .clk(clk_0_1),
        .dinb(BRAM_Interface_0_BRAM_din),
        .rsta_busy_0(BRAM_rsta_busy_0),
        .rstb_busy_0(BRAM_rstb_busy_0),
        .web(BRAM_Interface_0_BRAM_we));
  UART2PWM_BRAM_Interface_0_1 BRAM_Interface_0
       (.BRAM_addr(BRAM_Interface_0_BRAM_addr),
        .BRAM_din(BRAM_Interface_0_BRAM_din),
        .BRAM_we(BRAM_Interface_0_BRAM_we),
        .clk(clk_0_1),
        .din(UART_data_out),
        .intr(UART_intr),
        .rst(rst_0_1));
...
module UART_imp_NN1KY
  ...
  assign clk_0_1 = clk_0;
  assign data_out[7:0] = rx_mod_0_data_out;
  assign intr = rx_mod_0_intr;
  assign rst_0_1 = rst_0;
  assign sin_1 = sin_0;
