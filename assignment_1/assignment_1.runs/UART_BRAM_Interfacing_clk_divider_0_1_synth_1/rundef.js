...
ISEStep( "vivado",
         "-log UART_BRAM_Interfacing_clk_divider_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UART_BRAM_Interfacing_clk_divider_0_1.tcl" );
